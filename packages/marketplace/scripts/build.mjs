#!/usr/bin/env node
/**
 * Build script for @tutellus/agentic-marketplace.
 *
...
const PLUGIN_NAME = 'tut-ai';
const MARKETPLACE_NAME = 'tutellus-local';
...
// 7. Stop-guard script (generic quality command for npm-only installs)
...
console.log(`Built @tutellus/agentic-marketplace v${version}`);
console.log(`  .claude-plugin/marketplace.json`);
console.log(`  ${PLUGIN_NAME}/.claude-plugin/plugin.json`);
console.log(`  ${PLUGIN_NAME}/skills/ (16 skills)`);
console.log(`  ${PLUGIN_NAME}/agents/ (7 agents)`);
